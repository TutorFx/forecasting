...
--> statement-breakpoint
ALTER TABLE "forecast_requests" ADD COLUMN "series_id" uuid;--> statement-breakpoint
...
ALTER TABLE "forecast_requests" ADD CONSTRAINT "forecast_requests_series_id_time_series_id_fk" FOREIGN KEY ("series_id") REFERENCES "public"."time_series"("id") ON DELETE set null ON UPDATE no action;